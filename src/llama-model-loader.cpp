...
const char * llama_ftype_name(llama_ftype ftype) {
    ...
    switch ((enum llama_ftype) (ftype & ~LLAMA_FTYPE_GUESSED)) {
        ...
        case LLAMA_FTYPE_MOSTLY_CT_INT4:   name = LLAMA_FTYPE_PREFIX "CT_INT4 - compressed-tensors INT4 (group_size=128)"; break;
...
llama_model_loader::llama_model_loader(
    ...
    // TODO: make optional
    {
        ...
        switch (type_max) {
            ...
            case GGML_TYPE_CT_INT4:   ftype = LLAMA_FTYPE_MOSTLY_CT_INT4;   break;
            default:
                {
