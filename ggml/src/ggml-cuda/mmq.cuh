...
static mmq_q8_1_ds_layout mmq_get_q8_1_ds_layout(const ggml_type type_x) {
    switch (type_x) {
        ...
        case GGML_TYPE_Q8_0:
            return MMQ_Q8_1_DS_LAYOUT_D4;
        // CT_INT4 is affine ((c-8)*d), so its src1 (activation) quantization must
        // carry the per-32 activation sum, like Q4_K - the DS4 layout.
...
// ---------------------------------------------------------------------------------------------
            ...
            case GGML_TYPE_NVFP4_E8M0:
                return ggml_cuda_mmq_util_funcs(
                    VDR_NVFP4_E8M0_Q8_1_MMQ,
                    ggml_cuda_mmq_load_tiles_nvfp4_e8m0<type, J, fallback>,
                    ggml_cuda_mmq_vec_dot_q8_0_16_q8_1_dp4a<type, J, fallback>,
                    ggml_cuda_mmq_write_back_dp4a<type, J, fallback>);
            case GGML_TYPE_Q2_0_ROCMFPX:
                return ggml_cuda_mmq_util_funcs(
                    ...
                    ggml_cuda_mmq_vec_dot_rocmfpx_fp2_q8_1_dp4a<type, J, fallback>,
                    ggml_cuda_mmq_write_back_dp4a<type, J, fallback>);
            case GGML_TYPE_Q2_0_ROCMFPX_AFFINE:
                return ggml_cuda_mmq_util_funcs(
                    VDR_ROCMFP2_Q8_1_MMQ,
            ...
            case GGML_TYPE_Q6_0_ROCMFPX:
                return ggml_cuda_mmq_util_funcs(
                    ...
                    ggml_cuda_mmq_vec_dot_rocmfpx_fp6_q8_1_dp4a<type, J, fallback>,
                    ggml_cuda_mmq_write_back_dp4a<type, J, fallback>);
            case GGML_TYPE_Q8_0_ROCMFPX:
                return ggml_cuda_mmq_util_funcs(
