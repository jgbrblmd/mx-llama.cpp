...
GGML_API void quantize_row_ct_int4_ref(const float * GGML_RESTRICT x, block_ct_int4 * GGML_RESTRICT y, int64_t k);
...
GGML_API void dequantize_row_ct_int4(const block_ct_int4 * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
...
GGML_API size_t quantize_ct_int4(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);
