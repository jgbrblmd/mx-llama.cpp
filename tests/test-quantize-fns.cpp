...
constexpr float MAX_QUANTIZATION_TOTAL_ERROR_CT_INT4 = 0.03f;
    ...
    for (int i = 0; i < GGML_TYPE_COUNT; i++) {
        ...
        if (qfns_cpu->from_float && qfns->to_float) {
            ...
            const float max_quantization_error =
                ...
                type == GGML_TYPE_CT_INT4 ? MAX_QUANTIZATION_TOTAL_ERROR_CT_INT4 : MAX_QUANTIZATION_TOTAL_ERROR;
            ...
            if (vec_dot_error != INFINITY) {
                ...
                printf("%5s dot product error:              skipped (no vec_dot)\n", ggml_type_name(type));
            }
        }
    }
